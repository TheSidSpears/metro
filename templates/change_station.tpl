        ...
        <form name="change_query" method="post" action="index.php?p=c" accept-charset="utf-8">
            <font>{OLD_STATION_NAME}</font><br>
			{STATION_NAMES_RECORD}
			<hr>
            <font>{NEW_STATION_NAME}</font><br>
            <input name="station_name" size=20>
            ...
            <input type=submit name="submit" value="{C_BUTTON}">
        </form>